...
const Header = () => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-around gap-10 mt-8 mr-24 ">
                <div className="h-44 w-1/4 ml-4 rounded-b-4xl -mt-8 bg-[#C1FF5B] font-bold text-white text-8xl flex items-center justify-center">
                    Apex
                </div>
